...
## Key Files
- `apps/api/database/migrations/2026_02_23_000022_create_checklists_table.php`
- `apps/api/database/migrations/2026_02_23_000023_create_checklist_items_table.php`
- `apps/api/database/migrations/2026_02_23_000024_create_trade_checklist_responses_table.php`
- `apps/api/database/migrations/2026_02_23_000025_add_checklist_incomplete_to_trades_table.php`
- `apps/api/app/Services/ChecklistService.php`
- `apps/api/app/Services/TradeChecklistService.php`
- `apps/api/app/Http/Controllers/Api/ChecklistController.php`
- `apps/api/app/Http/Controllers/Api/ChecklistItemController.php`
- `apps/api/app/Http/Controllers/Api/TradeChecklistResponseController.php`
- `apps/api/routes/api.php`
- `apps/web/src/stores/rulesStore.ts`
- `apps/web/src/stores/tradeRulesStore.ts`
- `apps/web/src/components/rules/TradingRulesPage.vue`
- `apps/web/src/components/rules/RulesLibraryPanel.vue`
- `apps/web/src/components/rules/RulesBoardEditor.vue`
- `apps/web/src/components/rules/RuleItemRow.vue`
- `apps/web/src/components/rules/AddRuleModal.vue`
- `apps/web/src/components/rules/TradeRulesPanel.vue`
- `apps/web/src/components/rules/RuleProgressHeader.vue`
- `apps/web/src/components/rules/OptionalSection.vue`
- `apps/web/src/pages/TradeFormPage.vue`
- `apps/web/src/pages/TradingRulesPage.vue`
