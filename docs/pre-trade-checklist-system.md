...
## How It Works
- Users build reusable checklists in `/settings/checklists`.
- Each checklist has scope (`global` or `account`) and enforcement mode (`soft` or `strict`).
- Trade form loads the applicable checklist and tracks responses per item.
...
- `frontend/src/stores/checklistStore.ts`
- `frontend/src/stores/tradeChecklistStore.ts`
- `frontend/src/components/checklists/ChecklistBuilderPage.vue`
- `frontend/src/components/checklists/ChecklistListPanel.vue`
- `frontend/src/components/checklists/ChecklistEditor.vue`
- `frontend/src/components/checklists/ChecklistItemRow.vue`
- `frontend/src/components/checklists/AddChecklistItemModal.vue`
- `frontend/src/components/checklists/TradeChecklistPanel.vue`
- `frontend/src/components/checklists/ChecklistProgressHeader.vue`
- `frontend/src/components/checklists/OptionalSection.vue`
- `frontend/src/pages/TradeFormPage.vue`
- `frontend/src/pages/ChecklistBuilderPage.vue`
